...
document.addEventListener("DOMContentLoaded", function () { 
    ...
    if (query && searchBar) { //if both true than if condition 
        searchBar.value = query; //query value passed in searchbar
        fetchResults(query, 1);//fetch method call and take query eg=anjali,current  1
    }
});
